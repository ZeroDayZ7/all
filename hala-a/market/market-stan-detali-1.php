			...
			<tr>
								<td>
									<div class="stan-detali-z">
											...
											<button type="button" class="button-pojemnik-1" value="<?php echo $S1;?>">SK 481 HIGH
								...
								<td>
									<div class="stan-detali-z">
											...
											<button type="button" class="button-pojemnik-1" value="<?php echo $S2;?>">SK 482 HIGH
													<progress class="progress-stan-detali" 
													  id="file" 
								...
								<td>
									<div class="stan-detali-z">
											...
											<button type="button" class="button-pojemnik-1" value="<?php echo $S3;?>">SK 481 LOW
													<progress 
								...
								<td>
									<div class="stan-detali-z">
											...
											<button type="button" class="button-pojemnik-1" value="<?php echo $S4;?>">SK 482 LOW
													<progress 
																class="progress-stan-detali" 
																id="file" 
